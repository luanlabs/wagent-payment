  ...
  return (
    <StepWrapper title="Pay for your order" prevStep={prevStep} showNext={false}>
      <div className="mt-9 flex flex-col items-center">
        ...
        <div className="w-[172px] h-[172px] overflow-hidden border border-1 border-[#E4E7EC] rounded-xl mt-4">
          <img
        ...
        <section className="flex flex-col border border-1 border-[#FEDF89] rounded-xl w-[450px] mobile:w-full mt-7">
